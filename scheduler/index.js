...
const timeArray = [1000 * 60 * 60 * 24 * 365, 1000 * 60 * 60 * 24 * 30, 1000 * 60 * 60 * 24 * 7, 1000 * 60 * 60 * 24]
...
agenda.define(
    ...
    async job => {
        ...
        for (let rr of recurringReminders) {
            rr.nextDate = (rr.nextDate.getTime() + rr.every.reduce(function (r, a, i) { return r + a * timeArray[i] }, 0)).toISOString();
